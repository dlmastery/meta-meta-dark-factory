...
# EVD-004 Quality Certificate Worked Example
...
The `Quality Certificate` for CareQueue Pro records how the pilot will treat artifact verdict, thresholds, evidence bundle. It is linked to `INT-ANS-014 -> REQ-032 -> ARC-API-006 -> TST-ACPT-019 -> REL-GO-004` and remains non-authoritative until the real customer approves the project-specific version.
...
| Work ledger item | WL-CQ-EVD-004-001 |
| Accountable owner | Maya Patel, fictional clinic operations sponsor |
| Delivery owner | DFMS delivery lead |
| Review panel | Quality Lead, Governance Auditor, Human Owner mapped to artifact-specific critic seats |
...
- artifact verdict: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- thresholds: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- evidence bundle: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- conditions: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
...
| --- | --- | --- | --- | --- |
| INT-ANS-014 | REQ-032 | artifact verdict | TST-ACPT-019 | example only |
| INT-ANS-021 | NFR-SEC-004 | thresholds | SEC-REV-006 | example only |
| DEC-CQ-003 | ARC-ADR-002 | evidence bundle | REV-EVD-004-001 | example only |

## Example Review Notes

- Content authority critic asks whether `artifact verdict` is specific enough to guide downstream work.
