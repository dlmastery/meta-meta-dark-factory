...
**Example standard:** Provide a filled sample for `business process` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.
...
**Example standard:** Provide a filled sample for `business concepts` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Model Consistency

**Fill:** Check terminology, invariants, interfaces, quality attributes, and stakeholder validation.

**Example standard:** Provide a filled sample for `constraints` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Model Verification

**Fill:** Map model elements to requirements, tests, code, data, and review evidence.

**Example standard:** Provide a filled sample for `technology-free behavior` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.
