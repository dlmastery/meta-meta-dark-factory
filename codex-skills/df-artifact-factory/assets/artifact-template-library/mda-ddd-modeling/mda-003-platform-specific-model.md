...
**Example standard:** Provide a filled sample for `runtime stack` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Model Elements

**Fill:** List entities, value objects, services, interactions, state, events, constraints, and diagrams.

**Example standard:** Provide a filled sample for `module mapping` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Transformation Links

**Fill:** Trace CIM, PIM, PSM, exceptions, losses, platform decisions, and transformation rationale.

**Example standard:** Provide a filled sample for `deployment units` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Model Consistency

**Fill:** Check terminology, invariants, interfaces, quality attributes, and stakeholder validation.

**Example standard:** Provide a filled sample for `config` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.

### Model Verification

**Fill:** Map model elements to requirements, tests, code, data, and review evidence.

**Example standard:** Provide a filled sample for `platform constraints` with a source answer ID, owner, scope boundary, measurable acceptance evidence, downstream design/test link, and revalidation trigger. Use the worked example file as the minimum specificity bar.
