...
# MDA-001 Computation-Independent Model Worked Example
...
The `Computation-Independent Model` for CareQueue Pro records how the pilot will treat business process, actors, business concepts. It is linked to `INT-ANS-014 -> REQ-032 -> ARC-API-006 -> TST-ACPT-019 -> REL-GO-004` and remains non-authoritative until the real customer approves the project-specific version.
...
| Work ledger item | WL-CQ-MDA-001-001 |
| Accountable owner | Maya Patel, fictional clinic operations sponsor |
| Delivery owner | DFMS delivery lead |
| Review panel | MDA Architect, Domain Expert, Product Expert mapped to artifact-specific critic seats |
...
- business process: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- actors: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- business concepts: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- constraints: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- technology-free behavior: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.

## Example Trace Slice

| Source | Requirement | Artifact element | Evidence | Status |
| --- | --- | --- | --- | --- |
| INT-ANS-014 | REQ-032 | business process | TST-ACPT-019 | example only |
| INT-ANS-021 | NFR-SEC-004 | actors | SEC-REV-006 | example only |
| DEC-CQ-003 | ARC-ADR-002 | business concepts | REV-MDA-001-001 | example only |

## Example Review Notes

- Content authority critic asks whether `business process` is specific enough to guide downstream work.
