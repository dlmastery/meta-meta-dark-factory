...
# GOV-003 RASCI Matrix Worked Example
...
The `RASCI Matrix` for CareQueue Pro records how the pilot will treat accountable owners, approval authority, agent/human handoff. It is linked to `INT-ANS-014 -> REQ-032 -> ARC-API-006 -> TST-ACPT-019 -> REL-GO-004` and remains non-authoritative until the real customer approves the project-specific version.
...
| Work ledger item | WL-CQ-GOV-003-001 |
| Accountable owner | Maya Patel, fictional clinic operations sponsor |
| Delivery owner | DFMS delivery lead |
| Review panel | Governance Auditor, Delivery Manager, Human Owner mapped to artifact-specific critic seats |
...
- accountable owners: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- approval authority: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- agent/human handoff: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- segregation of duties: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.
- escalation path: example value recorded for the CareQueue pilot with owner, trace, evidence, and revalidation trigger.

## Example Trace Slice

| Source | Requirement | Artifact element | Evidence | Status |
| --- | --- | --- | --- | --- |
| INT-ANS-014 | REQ-032 | accountable owners | TST-ACPT-019 | example only |
| INT-ANS-021 | NFR-SEC-004 | approval authority | SEC-REV-006 | example only |
| DEC-CQ-003 | ARC-ADR-002 | agent/human handoff | REV-GOV-003-001 | example only |

## Example Review Notes

- Content authority critic asks whether `accountable owners` is specific enough to guide downstream work.
