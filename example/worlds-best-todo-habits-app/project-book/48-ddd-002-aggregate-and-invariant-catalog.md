...
| Work ledger item | WL-NORTHSTAR-RB08-DDD-002 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about aggregate and invariant catalog for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for DDD-002 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/48-ddd-002-aggregate-and-invariant-catalog.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen DDD-002 and downstream certificates.
...
| --- | --- | --- |
| 1 | DDD Critic | Verify DDD-002 against source files, trace links, tests, and coverage matrix |
| 2 | Test Lead | Verify DDD-002 against source files, trace links, tests, and coverage matrix |
| 3 | Implementation Lead | Verify DDD-002 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone DDD-002 document created. |
