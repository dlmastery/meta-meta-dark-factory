...
| Work ledger item | WL-NORTHSTAR-RB08-EVD-003 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about rubric scorecard for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for EVD-003 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/60-evd-003-rubric-scorecard.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen EVD-003 and downstream certificates.
...
| --- | --- | --- |
| 1 | Quality Lead | Verify EVD-003 against source files, trace links, tests, and coverage matrix |
| 2 | Governance Auditor | Verify EVD-003 against source files, trace links, tests, and coverage matrix |
| 3 | Selected Experts | Verify EVD-003 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone EVD-003 document created. |
