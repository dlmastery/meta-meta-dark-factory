...
| Standards basis | RUP inception, ISO agreement/project planning |
...
| Work ledger item | WL-NORTHSTAR-RB08-GOV-001 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about project charter for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for GOV-001 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/27-gov-001-project-charter.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen GOV-001 and downstream certificates.
...
| --- | --- | --- |
| 1 | Product Expert | Verify GOV-001 against source files, trace links, tests, and coverage matrix |
| 2 | Governance Auditor | Verify GOV-001 against source files, trace links, tests, and coverage matrix |
| 3 | Delivery Manager | Verify GOV-001 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone GOV-001 document created. |
