...
| Standards basis | ISO information item, RUP business modeling |
...
| Work ledger item | WL-NORTHSTAR-RB08-REQ-001 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about business requirements document for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for REQ-001 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/34-req-001-business-requirements-document.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen REQ-001 and downstream certificates.
...
| --- | --- | --- |
| 1 | Product Expert | Verify REQ-001 against source files, trace links, tests, and coverage matrix |
| 2 | Domain Expert | Verify REQ-001 against source files, trace links, tests, and coverage matrix |
| 3 | Requirements Lead | Verify REQ-001 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone REQ-001 document created. |
