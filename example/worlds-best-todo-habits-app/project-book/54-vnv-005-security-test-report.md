...
| Standards basis | SSDF, OWASP SAMM |
...
| Work ledger item | WL-NORTHSTAR-RB08-VNV-005 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about security test report for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for VNV-005 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/54-vnv-005-security-test-report.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen VNV-005 and downstream certificates.
...
| --- | --- | --- |
| 1 | Security Engineer | Verify VNV-005 against source files, trace links, tests, and coverage matrix |
| 2 | Test Lead | Verify VNV-005 against source files, trace links, tests, and coverage matrix |
| 3 | Governance Auditor | Verify VNV-005 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone VNV-005 document created. |
