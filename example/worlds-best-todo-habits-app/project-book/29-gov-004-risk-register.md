...
| Standards basis | ISO risk management, CMMI |
...
| Work ledger item | WL-NORTHSTAR-RB08-GOV-004 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about risk register for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for GOV-004 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/29-gov-004-risk-register.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen GOV-004 and downstream certificates.
...
| --- | --- | --- |
| 1 | Delivery Manager | Verify GOV-004 against source files, trace links, tests, and coverage matrix |
| 2 | Security Engineer | Verify GOV-004 against source files, trace links, tests, and coverage matrix |
| 3 | System Architect | Verify GOV-004 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone GOV-004 document created. |
