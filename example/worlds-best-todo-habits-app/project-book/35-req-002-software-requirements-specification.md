...
| Standards basis | ISO 12207/15289, IEEE-style SRS practice |
...
| Work ledger item | WL-NORTHSTAR-RB08-REQ-002 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about software requirements specification for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for REQ-002 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/35-req-002-software-requirements-specification.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen REQ-002 and downstream certificates.
...
| --- | --- | --- |
| 1 | Requirements Lead | Verify REQ-002 against source files, trace links, tests, and coverage matrix |
| 2 | Test Lead | Verify REQ-002 against source files, trace links, tests, and coverage matrix |
| 3 | Governance Auditor | Verify REQ-002 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone REQ-002 document created. |
