...
| Work ledger item | WL-NORTHSTAR-RB08-ARC-006 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about threat model for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for ARC-006 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/42-arc-006-threat-model.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen ARC-006 and downstream certificates.
...
| --- | --- | --- |
| 1 | Security Engineer | Verify ARC-006 against source files, trace links, tests, and coverage matrix |
| 2 | System Architect | Verify ARC-006 against source files, trace links, tests, and coverage matrix |
| 3 | Test Lead | Verify ARC-006 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone ARC-006 document created. |
