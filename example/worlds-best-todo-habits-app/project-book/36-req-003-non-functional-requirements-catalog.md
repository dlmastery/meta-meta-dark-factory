...
| --- | --- |
| Catalog ID | REQ-003 |
| Artifact | Non-Functional Requirements Catalog |
...
| Standards basis | ISO quality, SRE, security |
...
| Work ledger item | WL-NORTHSTAR-RB08-REQ-003 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about non-functional requirements catalog for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for REQ-003 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/36-req-003-non-functional-requirements-catalog.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen REQ-003 and downstream certificates.
...
| --- | --- | --- |
| 1 | SRE Lead | Verify REQ-003 against source files, trace links, tests, and coverage matrix |
| 2 | Security Engineer | Verify REQ-003 against source files, trace links, tests, and coverage matrix |
| 3 | System Architect | Verify REQ-003 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone REQ-003 document created. |
