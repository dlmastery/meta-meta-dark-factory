...
| --- | --- |
| Catalog ID | GOV-002 |
| Artifact | Standards Tailoring Matrix |
| Project | Northstar Daily todo plus habits demonstrator |
| Family | Governance and management |
| Lifecycle stage | Governance gate |
| Standards basis | ISO 12207, ISO 15289, company process |
...
| Work ledger item | WL-NORTHSTAR-RB08-GOV-002 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about standards tailoring matrix for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior combined coverage state for GOV-002 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/28-gov-002-standards-tailoring-matrix.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen GOV-002 and downstream certificates.
...
| --- | --- | --- |
| 1 | Governance Auditor | Verify GOV-002 against source files, trace links, tests, and coverage matrix |
| 2 | Quality Lead | Verify GOV-002 against source files, trace links, tests, and coverage matrix |
| 3 | Human Owner | Verify GOV-002 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone GOV-002 document created. |
