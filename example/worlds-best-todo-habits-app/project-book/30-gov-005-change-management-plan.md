...
| Work ledger item | WL-NORTHSTAR-RB08-GOV-005 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about change management plan for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for GOV-005 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/30-gov-005-change-management-plan.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen GOV-005 and downstream certificates.
...
| --- | --- | --- |
| 1 | Change Manager | Verify GOV-005 against source files, trace links, tests, and coverage matrix |
| 2 | Governance Auditor | Verify GOV-005 against source files, trace links, tests, and coverage matrix |
| 3 | Product Owner | Verify GOV-005 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone GOV-005 document created. |
