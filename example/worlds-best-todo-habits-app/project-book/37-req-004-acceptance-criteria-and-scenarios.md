...
| --- | --- |
| Catalog ID | REQ-004 |
| Artifact | Acceptance Criteria and Scenarios |
...
| Standards basis | BDD/TDD, dark factory validation |
...
| Work ledger item | WL-NORTHSTAR-RB08-REQ-004 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about acceptance criteria and scenarios for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for REQ-004 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/37-req-004-acceptance-criteria-and-scenarios.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen REQ-004 and downstream certificates.
...
| --- | --- | --- |
| 1 | Product Expert | Verify REQ-004 against source files, trace links, tests, and coverage matrix |
| 2 | QA Lead | Verify REQ-004 against source files, trace links, tests, and coverage matrix |
| 3 | Domain Expert | Verify REQ-004 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone REQ-004 document created. |
