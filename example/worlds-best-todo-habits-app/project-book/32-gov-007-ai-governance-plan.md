...
| Work ledger item | WL-NORTHSTAR-RB08-GOV-007 |
...
This artifact exists so a human reviewer can make a concrete assurance decision about ai governance plan for Northstar Daily without relying on a broad PRD paragraph, a dashboard card, or a future roadmap. It closes the prior partial coverage state for GOV-007 by creating a named standalone document with source evidence, trace, review, and reopening rules.
...
| Artifact coverage | project-book/32-gov-007-ai-governance-plan.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen GOV-007 and downstream certificates.
...
| --- | --- | --- |
| 1 | AI Governance Auditor | Verify GOV-007 against source files, trace links, tests, and coverage matrix |
| 2 | Security Engineer | Verify GOV-007 against source files, trace links, tests, and coverage matrix |
| 3 | Human Owner | Verify GOV-007 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone GOV-007 document created. |
