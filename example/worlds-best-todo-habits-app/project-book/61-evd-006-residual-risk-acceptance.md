...
| Work ledger item | WL-NORTHSTAR-RB08-EVD-006 |
...
| Artifact coverage | project-book/61-evd-006-residual-risk-acceptance.md, project-book/records/artifact-catalog-coverage-matrix.json |

## Risks And Controls

- Risk: this artifact can become stale after product or evidence changes. Control: redo closure must reopen EVD-006 and downstream certificates.
...
| --- | --- | --- |
| 1 | Human Owner | Verify EVD-006 against source files, trace links, tests, and coverage matrix |
| 2 | Security Engineer | Verify EVD-006 against source files, trace links, tests, and coverage matrix |
| 3 | Delivery Manager | Verify EVD-006 against source files, trace links, tests, and coverage matrix |
...
| ---: | --- | --- | --- |
| 1 | Check existence and artifact identity. | Look for missing standalone document. | Standalone EVD-006 document created. |
